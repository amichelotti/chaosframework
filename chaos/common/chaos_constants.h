...
static const char* const OPT_MSG_OPT = "msgopt-send";
...
static inline const int datasetTypeToPostfix(const std::string& ds_postfix) {
  if (ds_postfix.compare(DataPackPrefixID::OUTPUT_DATASET_POSTFIX) == 0) {
    return DataPackCommonKey::DPCK_DATASET_TYPE_OUTPUT;
  }
  if (ds_postfix.compare(DataPackPrefixID::INPUT_DATASET_POSTFIX) == 0) {
    return DataPackCommonKey::DPCK_DATASET_TYPE_INPUT;
  }
  if (ds_postfix.compare(DataPackPrefixID::CUSTOM_DATASET_POSTFIX) == 0) {
    return DataPackCommonKey::DPCK_DATASET_TYPE_CUSTOM;
  }
  if (ds_postfix.compare(DataPackPrefixID::SYSTEM_DATASET_POSTFIX) == 0) {
    return DataPackCommonKey::DPCK_DATASET_TYPE_SYSTEM;
  }
  if (ds_postfix.compare(DataPackPrefixID::DEV_ALARM_DATASET_POSTFIX) == 0) {
    return DataPackCommonKey::DPCK_DATASET_TYPE_DEV_ALARM;
  }
  if (ds_postfix.compare(DataPackPrefixID::CU_ALARM_DATASET_POSTFIX) == 0) {
    return DataPackCommonKey::DPCK_DATASET_TYPE_CU_ALARM;
  }
  if (ds_postfix.compare(DataPackPrefixID::HEALTH_DATASET_POSTFIX) == 0) {
    return DataPackCommonKey::DPCK_DATASET_TYPE_HEALTH;
  }
  if (ds_postfix.compare(DataPackPrefixID::COMMAND_DATASET_POSTFIX) == 0) {
    return DataPackCommonKey::DPCK_DATASET_TYPE_COMMAND;
  }
  if (ds_postfix.compare(DataPackPrefixID::LOG_DATASET_POSTFIX) == 0) {
