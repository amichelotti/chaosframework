...
/*!
             ...
             */
class AbstractControlUnit : public DeclareAction,
 ...
 public:
  ...
  inline int stateVariableNameToEnum(const std::string& name) {
    ...
    if (name.compare(chaos::ControlUnitDatapackSystemKey::DEV_ALRM_LEVEL) == 0) {
      return chaos::cu::control_manager::StateVariableTypeAlarmDEV;
    }
    return -1;
  }
...
*/
  ...
  inline AttributeSharedCacheWrapper* const getAttributeCache() {
