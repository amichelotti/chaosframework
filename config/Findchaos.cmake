...
#IF(KAFKA_RDK_ENABLE)
#  message(STATUS "ENABLING KAFKA RDK on ${PROJECT_NAME}")
#  SET(FrameworkLib ${FrameworkLib} rdkafka)
...
#  message(STATUS "ENABLING KAFKA ASIO on ${PROJECT_NAME}")
  ADD_DEFINITIONS(-DKAFKA_ASIO_ENABLE)
 SET(FrameworkLib ${FrameworkLib} snappy)
 link_directories(${CMAKE_INSTALL_PREFIX}/snappy/lib ${CMAKE_INSTALL_PREFIX}/snappy/lib64)
 ENDIF(KAFKA_ASIO_ENABLE)
